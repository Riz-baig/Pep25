...
def main():
    ...
    if opcion == 1:
        ...
        print("El seno de", angulo, "grados es:", sin(radians(angulo)))

    elif opcion == 2:
        angulo = float(input("Introduce el ángulo en grados: "))
        print("El coseno de", angulo, "grados es:",cos(radians(angulo)))
        ...
        if numero < 0:
            ...
            print("La raíz cuadrada de", numero, "es:", sqrt(numero))

    elif opcion == 4:
        base = float(input("Introduce la base: "))
        exponente = float(input("Introduce el exponente: "))
        print(base, "elevado a", exponente, "es:", pow(base, exponente))
